...
## FAKE JOB #1 - Work From Home Scam
```
...
Contact: premium.jobs.india@gmail.com
WhatsApp: +91-9876543210
```

---

## FAKE JOB #2 - Visa Sponsorship Scam
```
...
Email: tcs.usajobs@gmail.com (Not official TCS)
Phone: +91-7654321098
```

---

## FAKE JOB #3 - Amazon Phishing
```
...
Contact: amazon.support.in@outlook.com
Website: Not provided
```

---

## REAL JOB #1 - Microsoft Official
```
...
How to Apply:
Visit: https://careers.microsoft.com
Upload your resume and cover letter
Complete coding assessment
Technical interview rounds

Contact: careers-india@microsoft.com
Phone: +91-22-33445566
Website: https://www.microsoft.com/en-in/careers
```

---

## REAL JOB #2 - Goldman Sachs
```
...
Application Process:
1. Visit: https://www.goldmansachs.com/careers
2. Apply online with resume
...
How to Apply:
1. Visit: https://www.accenture.com/in-en/careers
2. Search for "Technology Analyst"
...
About Infosys:
Infosys is a global leader in IT services and consulting. We create digital experiences that matter to people, businesses, and society.

Position Details:
We are hiring software engineers to work on various technology platforms for global clients.
...
Requirements:
- Bachelor's degree in Engineering (any stream)
...
Application Process:
1. Visit: https://www.infosys.com/careers (Official website)
2. Apply through careers portal
3. Complete aptitude assessment
4. Technical interview
5. HR interview

Contact: careers@infosys.com
Phone: 1800-102-9779 (Toll-free India)
Website: https://www.infosys.com
```

---

## FAKE JOB #5 - Freelance Scam
```
...
Contact Info:
Email: dataentry.work@gmail.com
WhatsApp: https://wa.me/919876543210
Telegram: @dataentry_guru

Thousands are already earning! Don't miss out!
```
...
2. **Click "Analyze" or "New Analysis"** button

3. **Copy and paste any job posting above** into the form

4. **Fill other details:**
   - Recruiter Email (from posting)
   - Company Name
   - Phone Number (from posting)

5. **Click Submit** to see the analysis
...
**FAKE JOBS:** Should show HIGH RISK (85+/100)
- TCS Visa Scam
- Amazon Phishing  
- Work From Home Scam
...
**REAL JOBS:** Should show LOW RISK (10-15/100)
- Microsoft
- Goldman Sachs
- Accenture
- Infosys Official
...
3. Go to "History" to show previous analyses
4. Go to "Analyze" page
5. Paste a FAKE job posting → Show HIGH RISK result
6. Explain red flags detected
7. Paste a REAL job posting → Show LOW RISK result
8. Explain why it's legitimate
9. Show detection accuracy
